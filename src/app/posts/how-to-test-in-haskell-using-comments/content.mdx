...
import StackBuildExec from "./stack_build_exec.png";
import StackGhci from "./stack_ghci.png";
import StackTest1 from "./stack_test_1.png";
import StackTest2 from "./stack_test_2.png";
...
<Image
  src={StackBuildExec}
  alt="Output after running `stack build` and `stack exec my-project-exe`"
/>
...
<Image src={StackGhci} alt="Testing our square function" />
...
<Image src={StackTest1} alt="Test suite not implemented" />
...
<Image src={StackTest2} alt="Tests pass successfully" />
